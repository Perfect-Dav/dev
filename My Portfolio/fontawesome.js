...
!function() {
    ...
    function a(e) {
        ...
        Array.prototype.forEach.call(t, function(e) {
            ...
            n && i && ((o = document.createElement("span")).innerHTML = n,
    ...
    var d = function(e, t) {
      ...
      , e = function(e, t, n) {
        ...
        i && (a.setAttributeNode(document.createAttribute("data-auto-fetch-svg")),
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            ...
            "pro" === i.license && (l.autoFetchSvg = !0,
            l.fetchSvgFrom = i.baseUrl + "/releases/" + ("latest" === i.version ? "latest" : "v".concat(i.version)) + "/svgs"),
            ...
            "css" === f.method && function(e, t) {
                ...
                e.autoA11y.enabled && (r(i),
                n = i,
                "undefined" != typeof MutationObserver && new MutationObserver(n).observe(document, {
                    childList: !0,
                    subtree: !0
                })),
                e.v4shim.enabled && (e.license,
                e.asyncLoading.enabled ? c(s(e, {
                    addOn: "-v4-shims",
            ...
            m.detectingConflicts && ((u = document.currentScript.getAttribute(m.detectionTimeoutAttr)) && (m.detectionTimeout = u),
